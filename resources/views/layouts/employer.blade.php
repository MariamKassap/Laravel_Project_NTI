...
<body class="bg-[#F8FAFC] font-sans text-slate-700 antialiased">
    ...
    <i class="fa-solid fa-user-group"></i> Applicants
                    ...
                    <!-- Static UI Elements (No Logic Attached) -->
                ...
                <div class="flex items-center gap-6">
                    ...
                    <div class="flex items-center gap-3 border-l border-slate-200 pl-6">
                        <div class="text-right">
                            <div class="text-sm font-semibold text-slate-800">{{ auth()->user()->company ?? auth()->user()->name }}</div>
                            <div class="text-xs text-slate-400">Hiring Manager</div>
                        </div>
